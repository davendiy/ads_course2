...
class ConfigDict:
    ...
    def __init__(self, filename, default_dict=None):
        ...
        self._dct = default_dict if isinstance(default_dict, dict) else {}  # словник імен та значень виразів
...
if __name__ == '__main__':
    test_filename = input("Ім'я файлу: ")
    conf = ConfigDict(test_filename)
    print('\n\n', conf.getconfig())
