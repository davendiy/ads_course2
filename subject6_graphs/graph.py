...
from subject6_graphs.vertex import Vertex
...
def inputGraphNet(gr):
    """ Ініціалізація графу-мережі, тобто графу, що не має циклів та має одне джерело та один сток
...
if __name__ == "__main__":  # Для тестування
    ...
    test_g = Graph(True)  # Створюємо орієнтований граф

    # inputConcreteGraph2(g)

    test_points = 10
    test_edges = 20
    inputRandomGraph(test_g, test_points, test_edges)
